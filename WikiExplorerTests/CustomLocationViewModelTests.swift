...
struct CustomLocationViewModelTests {
    ...
    func invalidNumbers() async throws {
        ...
        await sut.validateCoordinatesAndConnectApp(lat: "abc", long: "123")
    ...
    func latitudeOutOfBounds() async throws {
        ...
        await sut.validateCoordinatesAndConnectApp(lat: "-90.1", long: "0")
    ...
    func longitudeOutOfBounds() async throws {
        ...
        await sut.validateCoordinatesAndConnectApp(lat: "0", long: "-180.5")
    ...
    func trimsWhitespaceAndConnects() async throws {
        ...
        await sut.validateCoordinatesAndConnectApp(lat: "  12.34  ", long: "  -56.78\n")
    ...
    func connectSuccess() async throws {
        ...
        await sut.connectToApp(lat: 1, long: 2)
